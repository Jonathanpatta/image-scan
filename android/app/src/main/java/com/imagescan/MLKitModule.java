...
class BarcodeScanningActivity extends AppCompatActivity {
    ...
    private void scanBarcodes(InputImage image) {
        ...
        while(!result.isComplete() || times<15000000){
...
public class MLKitModule  extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void MyFunction(String FileName,String taskid, Callback FailureCallback, Callback SuccessCallback){
